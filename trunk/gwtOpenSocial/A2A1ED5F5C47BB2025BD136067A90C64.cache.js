...
var $intern_9 = ' ', $intern_5 = '403', $intern_7 = 'An unexpected error occurred.', $intern_11 = 'FRIENDS', $intern_1 = 'Here ', $intern_17 = 'Object;', $intern_6 = 'Please adjust the gadgets settings to use social features', $intern_10 = 'VIEWER', $intern_16 = '[Ljava.lang.', $intern_15 = 'com.example.friends.client.Friends', $intern_3 = 'else', $intern_4 = 'forbidden', $intern_2 = 'if ', $intern_13 = 'moduleStartup', $intern_14 = 'onModuleLoadStart', $intern_12 = 'startup', $intern_0 = 'viewer', $intern_8 = 'viewerFriends';
var _;
...
function com_example_friends_client_Friends_onLoadFriends__Lcom_google_gwt_core_client_JavaScriptObject_2(data){
  ...
  if (!viewer.hadError()) {
    ...
    if (viewer.getErrorCode() == $intern_4 || viewer.getErrorCode() == $intern_5) {
...
function com_example_friends_client_Friends_printData__Lcom_google_gwt_core_client_JavaScriptObject_2(data){
  ...
  var viewerFriends = data.get($intern_8).getData();
...
function com_example_friends_client_FriendsGadgetImpl_$FriendsGadgetImpl__Lcom_example_friends_client_FriendsGadgetImpl_2(this$static){
  ...
  com_example_friends_client_Friends_$getName__Lcom_example_friends_client_Friends_2_req_0.add(com_example_friends_client_Friends_$getName__Lcom_example_friends_client_Friends_2_req_0.newFetchPersonRequest($intern_10), $intern_0);
  com_example_friends_client_Friends_$getName__Lcom_example_friends_client_Friends_2_viewerFriends_0 = $wnd.opensocial.newIdSpec({userId:$intern_10, groupId:$intern_11});
...
var com_google_gwt_lang_ClassLiteralHolder__13Ljava_1lang_1Object_12_1classLit = java_lang_Class_createForArray__Ljava_lang_String_2Ljava_lang_String_2($intern_16, $intern_17);
