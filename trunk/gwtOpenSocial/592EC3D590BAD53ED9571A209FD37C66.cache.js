...
var $intern_4 = '', $intern_14 = '\n ', $intern_19 = ' out of range', $intern_21 = '"', $intern_7 = '(', $intern_8 = '): ', $intern_3 = ',', $intern_26 = ', ', $intern_32 = ', Size: ', $intern_23 = ':', $intern_6 = ': ', $intern_29 = '=', $intern_0 = '@', $intern_66 = 'AbstractCollection', $intern_68 = 'AbstractHashMap', $intern_70 = 'AbstractHashMap$EntrySet', $intern_71 = 'AbstractHashMap$EntrySetIterator', $intern_73 = 'AbstractHashMap$MapEntryNull', $intern_74 = 'AbstractHashMap$MapEntryString', $intern_75 = 'AbstractList', $intern_76 = 'AbstractList$IteratorImpl', $intern_67 = 'AbstractMap', $intern_72 = 'AbstractMapEntry', $intern_69 = 'AbstractSet', $intern_24 = 'Add not supported on this collection', $intern_77 = 'ArrayList', $intern_56 = 'ArrayStoreException', $intern_58 = 'Class', $intern_59 = 'ClassCastException', $intern_50 = 'Exception', $intern_20 = 'For input string: "', $intern_46 = 'Friends', $intern_47 = 'FriendsGadgetImpl', $intern_44 = 'Gadget', $intern_78 = 'HashMap', $intern_60 = 'IllegalArgumentException', $intern_31 = 'Index: ', $intern_55 = 'IndexOutOfBoundsException', $intern_53 = 'JavaScriptException', $intern_54 = 'JavaScriptObject$', $intern_79 = 'NoSuchElementException', $intern_61 = 'NumberFormatException', $intern_42 = 'Object', $intern_64 = 'Object;', $intern_48 = 'OpenSocialFeature', $intern_81 = 'Pattern', $intern_51 = 'RuntimeException', $intern_10 = 'String', $intern_40 = 'String;', $intern_62 = 'StringBuffer', $intern_49 = 'Throwable', $intern_63 = 'UnsupportedOperationException', $intern_25 = '[', $intern_2 = '[1-9],{0,1}(\\d)* \u20AA', $intern_57 = '[C', $intern_15 = '[JavaScriptObject]', $intern_39 = '[Ljava.lang.', $intern_27 = ']', $intern_17 = 'class ', $intern_45 = 'com.example.friends.client.', $intern_38 = 'com.example.friends.client.Friends', $intern_52 = 'com.google.gwt.core.client.', $intern_43 = 'com.google.gwt.gadgets.client.', $intern_22 = 'g', $intern_5 = 'http://www.zap.co.il/model.aspx?modelid=738461', $intern_34 = 'i', $intern_16 = 'interface ', $intern_41 = 'java.lang.', $intern_65 = 'java.util.', $intern_33 = 'm', $intern_12 = 'message', $intern_36 = 'moduleStartup', $intern_11 = 'name', $intern_9 = 'null', $intern_37 = 'onModuleLoadStart', $intern_80 = 'org.gwtwidgets.client.util.regex.', $intern_18 = 'radix ', $intern_1 = 'response', $intern_35 = 'startup', $intern_13 = 'toString', $intern_28 = '{', $intern_30 = '}';
var _;
...
_.java_lang_Object_typeId$ = 0;
_.com_example_friends_client_Friends_linkText = $intern_4;
function com_example_friends_client_FriendsGadgetImpl_$FriendsGadgetImpl__Lcom_example_friends_client_FriendsGadgetImpl_2(this$static){
  ...
  com_example_friends_client_Friends_$bringLink__Lcom_example_friends_client_Friends_2Ljava_lang_String_2(this$static, $intern_5);
  return this$static;
}
...
function com_google_gwt_core_client_JavaScriptException_getMessage__(){
  if (this.com_google_gwt_core_client_JavaScriptException_message == null) {
    ...
    this.com_google_gwt_core_client_JavaScriptException_message = $intern_7 + this.com_google_gwt_core_client_JavaScriptException_name + $intern_8 + this.com_google_gwt_core_client_JavaScriptException_description + com_google_gwt_core_client_JavaScriptException_getProperties__Ljava_lang_Object_2(this.com_google_gwt_core_client_JavaScriptException_e);
  }
...
function com_google_gwt_core_client_JavaScriptException_getProperties__Ljava_lang_Object_2(e){
  return e != null && (e.java_lang_Object_typeMarker$ != nullMethod && e.java_lang_Object_typeId$ != 2)?com_google_gwt_core_client_JavaScriptException_getProperties0__Lcom_google_gwt_core_client_JavaScriptObject_2(com_google_gwt_lang_Cast_dynamicCastJso__Ljava_lang_Object_2(e)):$intern_4;
}
...
function com_google_gwt_core_client_JavaScriptException_getProperties0__Lcom_google_gwt_core_client_JavaScriptObject_2(e){
  ...
  try {
    for (prop in e) {
      if (prop != $intern_11 && (prop != $intern_12 && prop != $intern_13)) {
        try {
          result += $intern_14 + prop + $intern_6 + e[prop];
        }
         catch (ignored) {
        }
      }
...
function com_google_gwt_core_client_JavaScriptObject_$toString__Lcom_google_gwt_core_client_JavaScriptObject_2(this$static){
  return this$static.toString?this$static.toString():$intern_15;
}
...
function com_google_gwt_core_client_JavaScriptObject_toString_1_1devirtual$__Ljava_lang_Object_2(this$static){
  return this$static.java_lang_Object_typeMarker$ == nullMethod || this$static.java_lang_Object_typeId$ == 2?this$static.toString__$():this$static.toString?this$static.toString():$intern_15;
}
...
function java_lang_Class_toString__(){
  return ((this.java_lang_Class_modifiers & 2) != 0?$intern_16:(this.java_lang_Class_modifiers & 1) != 0?$intern_4:$intern_17) + this.java_lang_Class_typeName;
}
...
function java_lang_Number__1_1parseAndValidateInt__Ljava_lang_String_2III(s, radix, lowerBound, upperBound){
  ...
  if (s == null) {
    throw java_lang_NumberFormatException_$NumberFormatException__Ljava_lang_NumberFormatException_2Ljava_lang_String_2(new java_lang_NumberFormatException(), $intern_9);
  }
  if (radix < 2 || radix > 36) {
    throw java_lang_NumberFormatException_$NumberFormatException__Ljava_lang_NumberFormatException_2Ljava_lang_String_2(new java_lang_NumberFormatException(), $intern_18 + radix + $intern_19);
  }
  length = s.length;
  startIndex = length > 0 && s.charCodeAt(0) == 45?1:0;
  for (i = startIndex; i < length; ++i) {
    if (java_lang_Character_digit__CI(s.charCodeAt(i), radix) == -1) {
      throw java_lang_NumberFormatException_$NumberFormatException__Ljava_lang_NumberFormatException_2Ljava_lang_String_2(new java_lang_NumberFormatException(), $intern_20 + s + $intern_21);
    }
  }
...
function java_lang_String_$split__Ljava_lang_String_2Ljava_lang_String_2I(this$static, regex, maxMatch){
  var compiled = new RegExp(regex, $intern_22);
  var out = [];
  var count = 0;
  ...
  while (true) {
    ...
    if (matchObj == null || (trail == $intern_4 || count == maxMatch - 1 && maxMatch > 0)) {
      out[count] = trail;
      break;
    }
     else {
  ...
  if (maxMatch == 0) {
    ...
    while (lastNonEmpty > 0 && out[lastNonEmpty - 1] == $intern_4) {
      --lastNonEmpty;
    }
...
function java_util_AbstractCollection_add__Ljava_lang_Object_2(o){
  throw java_lang_UnsupportedOperationException_$UnsupportedOperationException__Ljava_lang_UnsupportedOperationException_2Ljava_lang_String_2(new java_lang_UnsupportedOperationException(), $intern_24);
}
...
function java_util_AbstractCollection_toString__(){
  ...
  comma = null;
  com_google_gwt_core_client_impl_StringBufferImplArrayBase_$append__Lcom_google_gwt_core_client_impl_StringBufferImplArrayBase_2Ljava_lang_Object_2Ljava_lang_String_2(sb.java_lang_StringBuffer_data, $intern_25);
  ...
  while (iter.hasNext__()) {
    ...
    java_lang_StringBuffer_$append__Ljava_lang_StringBuffer_2Ljava_lang_String_2(sb, $intern_4 + iter.next__());
  }
...
function java_util_AbstractMap_toString__(){
  ...
  for (iter = java_util_AbstractHashMap$EntrySetIterator_$AbstractHashMap$EntrySetIterator__Ljava_util_AbstractHashMap$EntrySetIterator_2(new java_util_AbstractHashMap$EntrySetIterator(), java_util_AbstractHashMap$EntrySet_$AbstractHashMap$EntrySet__Ljava_util_AbstractHashMap$EntrySet_2(new java_util_AbstractHashMap$EntrySet(), com_google_gwt_lang_Cast_dynamicCast__Ljava_lang_Object_2I(this, 6)).java_util_AbstractHashMap$EntrySet_this$0); java_util_AbstractList$IteratorImpl_$hasNext__Ljava_util_AbstractList$IteratorImpl_2(iter.java_util_AbstractHashMap$EntrySetIterator_iter);) {
    ...
    s += $intern_4 + entry.getKey__();
    s += $intern_29;
    s += $intern_4 + entry.getValue__();
  }
  return s + $intern_30;
}
...
function java_util_AbstractMapEntry_toString__(){
  return this.getKey__() + $intern_29 + this.getValue__();
}
...
function java_util_AbstractHashMap$MapEntryString_getValue__(){
  return this.java_util_AbstractHashMap$MapEntryString_this$0.java_util_AbstractHashMap_stringMap[$intern_23 + this.java_util_AbstractHashMap$MapEntryString_key];
}
...
function java_util_AbstractList_indexOutOfBounds__II(index, size){
  throw java_lang_IndexOutOfBoundsException_$IndexOutOfBoundsException__Ljava_lang_IndexOutOfBoundsException_2Ljava_lang_String_2(new java_lang_IndexOutOfBoundsException(), $intern_31 + index + $intern_32 + size);
}
...
var com_google_gwt_lang_ClassLiteralHolder__13Ljava_1lang_1String_12_1classLit = java_lang_Class_createForArray__Ljava_lang_String_2Ljava_lang_String_2($intern_39, $intern_40), com_google_gwt_lang_ClassLiteralHolder_Ljava_1lang_1Object_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_41, $intern_42), com_google_gwt_lang_ClassLiteralHolder_Lcom_1google_1gwt_1gadgets_1client_1Gadget_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_43, $intern_44), com_google_gwt_lang_ClassLiteralHolder_Lcom_1example_1friends_1client_1Friends_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_45, $intern_46), com_google_gwt_lang_ClassLiteralHolder_Lcom_1example_1friends_1client_1FriendsGadgetImpl_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_45, $intern_47), com_google_gwt_lang_ClassLiteralHolder_Lcom_1example_1friends_1client_1OpenSocialFeature_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_45, $intern_48), com_google_gwt_lang_ClassLiteralHolder_Ljava_1lang_1Throwable_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_41, $intern_49), com_google_gwt_lang_ClassLiteralHolder_Ljava_1lang_1Exception_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_41, $intern_50), com_google_gwt_lang_ClassLiteralHolder_Ljava_1lang_1RuntimeException_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_41, $intern_51), com_google_gwt_lang_ClassLiteralHolder_Lcom_1google_1gwt_1core_1client_1JavaScriptException_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_52, $intern_53), com_google_gwt_lang_ClassLiteralHolder_Lcom_1google_1gwt_1core_1client_1JavaScriptObject_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_52, $intern_54), com_google_gwt_lang_ClassLiteralHolder_Ljava_1lang_1IndexOutOfBoundsException_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_41, $intern_55), com_google_gwt_lang_ClassLiteralHolder_Ljava_1lang_1ArrayStoreException_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_41, $intern_56), com_google_gwt_lang_ClassLiteralHolder__13C_1classLit = java_lang_Class_createForArray__Ljava_lang_String_2Ljava_lang_String_2($intern_4, $intern_57), com_google_gwt_lang_ClassLiteralHolder_Ljava_1lang_1Class_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_41, $intern_58), com_google_gwt_lang_ClassLiteralHolder_Ljava_1lang_1ClassCastException_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_41, $intern_59), com_google_gwt_lang_ClassLiteralHolder_Ljava_1lang_1IllegalArgumentException_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_41, $intern_60), com_google_gwt_lang_ClassLiteralHolder_Ljava_1lang_1NumberFormatException_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_41, $intern_61), com_google_gwt_lang_ClassLiteralHolder_Ljava_1lang_1String_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_41, $intern_10), com_google_gwt_lang_ClassLiteralHolder_Ljava_1lang_1StringBuffer_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_41, $intern_62), com_google_gwt_lang_ClassLiteralHolder_Ljava_1lang_1UnsupportedOperationException_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_41, $intern_63), com_google_gwt_lang_ClassLiteralHolder__13Ljava_1lang_1Object_12_1classLit = java_lang_Class_createForArray__Ljava_lang_String_2Ljava_lang_String_2($intern_39, $intern_64), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1AbstractCollection_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_65, $intern_66), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1AbstractMap_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_65, $intern_67), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1AbstractHashMap_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_65, $intern_68), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1AbstractSet_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_65, $intern_69), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1AbstractHashMap$EntrySet_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_65, $intern_70), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1AbstractHashMap$EntrySetIterator_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_65, $intern_71), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1AbstractMapEntry_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_65, $intern_72), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1AbstractHashMap$MapEntryNull_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_65, $intern_73), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1AbstractHashMap$MapEntryString_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_65, $intern_74), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1AbstractList_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_65, $intern_75), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1AbstractList$IteratorImpl_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_65, $intern_76), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1ArrayList_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_65, $intern_77), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1HashMap_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_65, $intern_78), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1NoSuchElementException_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_65, $intern_79), com_google_gwt_lang_ClassLiteralHolder_Lorg_1gwtwidgets_1client_1util_1regex_1Pattern_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_80, $intern_81);
