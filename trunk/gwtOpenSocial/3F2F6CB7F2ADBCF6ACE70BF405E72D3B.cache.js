...
var $intern_2 = ' ', $intern_8 = ' and his name : ', $intern_14 = ', Size: ', $intern_9 = '1', $intern_4 = '403', $intern_6 = 'An unexpected error occurred.', $intern_12 = 'FRIENDS', $intern_13 = 'Index: ', $intern_20 = 'Object;', $intern_5 = 'Please adjust the gadgets settings to use social features', $intern_11 = 'VIEWER', $intern_19 = '[Ljava.lang.', $intern_18 = 'com.example.friends.client.Friends', $intern_3 = 'forbidden', $intern_16 = 'moduleStartup', $intern_17 = 'onModuleLoadStart', $intern_10 = 'one', $intern_15 = 'startup', $intern_0 = 'viewer', $intern_1 = 'viewerFriends', $intern_7 = 'your friend id is : ';
var _;
...
function com_example_friends_client_Friends_print__(){
  ...
  for (i = 0; i < this.com_example_friends_client_Friends_userFriends.java_util_ArrayList_size; ++i) {
    $wnd.alert($intern_7 + com_google_gwt_lang_Cast_dynamicCast__Ljava_lang_Object_2I(java_util_ArrayList_$get__Ljava_util_ArrayList_2I(this.com_example_friends_client_Friends_userFriends, i), 2).com_example_friends_client_Person_id + $intern_8 + com_google_gwt_lang_Cast_dynamicCast__Ljava_lang_Object_2I(java_util_ArrayList_$get__Ljava_util_ArrayList_2I(this.com_example_friends_client_Friends_userFriends, i), 2).com_example_friends_client_Person_name);
  }
}
...
function com_example_friends_client_FriendsGadgetImpl_$FriendsGadgetImpl__Lcom_example_friends_client_FriendsGadgetImpl_2(this$static){
  ...
  this$static.com_example_friends_client_Friends_user = com_example_friends_client_Person_$Person__Lcom_example_friends_client_Person_2Ljava_lang_String_2Ljava_lang_String_2(new com_example_friends_client_Person(), $intern_9, $intern_10);
...
function java_util_AbstractList_indexOutOfBounds__II(index, size){
  throw java_lang_IndexOutOfBoundsException_$IndexOutOfBoundsException__Ljava_lang_IndexOutOfBoundsException_2Ljava_lang_String_2(new java_lang_IndexOutOfBoundsException(), $intern_13 + index + $intern_14 + size);
}
...
function init(){
  !!$stats && $stats({moduleName:$moduleName, subSystem:$intern_15, evtGroup:$intern_16, millis:(new Date()).getTime(), type:$intern_17, className:$intern_18});
...
var com_google_gwt_lang_ClassLiteralHolder__13Ljava_1lang_1Object_12_1classLit = java_lang_Class_createForArray__Ljava_lang_String_2Ljava_lang_String_2($intern_19, $intern_20);
