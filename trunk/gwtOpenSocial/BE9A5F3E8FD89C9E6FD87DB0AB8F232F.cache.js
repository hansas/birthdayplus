...
var $intern_6 = ' ', $intern_2 = '403', $intern_4 = 'An unexpected error occurred.', $intern_8 = 'FRIENDS', $intern_14 = 'Object;', $intern_3 = 'Please adjust the gadgets settings to use social features', $intern_7 = 'VIEWER', $intern_13 = '[Ljava.lang.', $intern_12 = 'com.example.friends.client.Friends', $intern_1 = 'forbidden', $intern_10 = 'moduleStartup', $intern_11 = 'onModuleLoadStart', $intern_9 = 'startup', $intern_0 = 'viewer', $intern_5 = 'viewerFriends';
var _;
...
function com_example_friends_client_Friends_onLoadFriends__Lcom_google_gwt_core_client_JavaScriptObject_2(data){
  ...
  if (!viewer.hadError()) {
    ...
    if (viewer.getErrorCode() == $intern_1 || viewer.getErrorCode() == $intern_2) {
...
function com_example_friends_client_Friends_printData__Lcom_google_gwt_core_client_JavaScriptObject_2(data){
  var viewer = data.get($intern_0).getData();
  var viewerFriends = data.get($intern_5).getData();
