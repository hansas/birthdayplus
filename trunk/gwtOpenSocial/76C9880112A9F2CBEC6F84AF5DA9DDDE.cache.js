...
function com_example_friends_client_Friends_onLoadFriends__Lcom_google_gwt_core_client_JavaScriptObject_2(data){
  if (!data.hadError()) {
    ...
    this.com_example_friends_client_Friends_viewer.nullMethod(viewer.getId());
    viewer.nullMethod(viewer.getDisplayName());
    $wnd.document.write(this.com_example_friends_client_Friends_viewer);
...
_.java_lang_Object_typeId$ = 0;
_.com_example_friends_client_Friends_viewer = null;
