...
var $intern_2 = ' ', $intern_6 = 'FRIENDS', $intern_12 = 'Object;', $intern_5 = 'VIEWER', $intern_11 = '[Ljava.lang.', $intern_10 = 'com.example.friends.client.Friends', $intern_8 = 'moduleStartup', $intern_3 = 'name', $intern_4 = 'noop', $intern_9 = 'onModuleLoadStart', $intern_7 = 'startup', $intern_0 = 'viewer', $intern_1 = 'viewerFriends';
var _;
...
function com_example_friends_client_Friends_onLoadFriends__Lcom_google_gwt_core_client_JavaScriptObject_2(data){
  if (!data.hadError()) {
    ...
    $wnd.document.write(viewer.getName());
    this.com_example_friends_client_Friends_user.setName__Ljava_lang_String_2($intern_3);
