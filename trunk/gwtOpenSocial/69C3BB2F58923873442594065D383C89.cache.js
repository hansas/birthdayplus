...
var $intern_5 = '', $intern_15 = '\n ', $intern_20 = ' out of range', $intern_22 = '"', $intern_8 = '(', $intern_9 = '): ', $intern_3 = ',', $intern_27 = ', ', $intern_33 = ', Size: ', $intern_24 = ':', $intern_7 = ': ', $intern_30 = '=', $intern_0 = '@', $intern_67 = 'AbstractCollection', $intern_69 = 'AbstractHashMap', $intern_71 = 'AbstractHashMap$EntrySet', $intern_72 = 'AbstractHashMap$EntrySetIterator', $intern_74 = 'AbstractHashMap$MapEntryNull', $intern_75 = 'AbstractHashMap$MapEntryString', $intern_76 = 'AbstractList', $intern_77 = 'AbstractList$IteratorImpl', $intern_68 = 'AbstractMap', $intern_73 = 'AbstractMapEntry', $intern_70 = 'AbstractSet', $intern_25 = 'Add not supported on this collection', $intern_78 = 'ArrayList', $intern_57 = 'ArrayStoreException', $intern_59 = 'Class', $intern_60 = 'ClassCastException', $intern_51 = 'Exception', $intern_21 = 'For input string: "', $intern_47 = 'Friends', $intern_48 = 'FriendsGadgetImpl', $intern_45 = 'Gadget', $intern_79 = 'HashMap', $intern_61 = 'IllegalArgumentException', $intern_32 = 'Index: ', $intern_56 = 'IndexOutOfBoundsException', $intern_54 = 'JavaScriptException', $intern_55 = 'JavaScriptObject$', $intern_80 = 'NoSuchElementException', $intern_62 = 'NumberFormatException', $intern_43 = 'Object', $intern_65 = 'Object;', $intern_49 = 'OpenSocialFeature', $intern_82 = 'Pattern', $intern_52 = 'RuntimeException', $intern_11 = 'String', $intern_41 = 'String;', $intern_63 = 'StringBuffer', $intern_50 = 'Throwable', $intern_64 = 'UnsupportedOperationException', $intern_26 = '[', $intern_2 = '[1-9],{0,1}(\\d)* \u20AA', $intern_58 = '[C', $intern_16 = '[JavaScriptObject]', $intern_40 = '[Ljava.lang.', $intern_28 = ']', $intern_18 = 'class ', $intern_46 = 'com.example.friends.client.', $intern_39 = 'com.example.friends.client.Friends', $intern_53 = 'com.google.gwt.core.client.', $intern_44 = 'com.google.gwt.gadgets.client.', $intern_23 = 'g', $intern_6 = 'http://www.zap.co.il/model.aspx?modelid=738461', $intern_35 = 'i', $intern_17 = 'interface ', $intern_42 = 'java.lang.', $intern_66 = 'java.util.', $intern_34 = 'm', $intern_13 = 'message', $intern_37 = 'moduleStartup', $intern_12 = 'name', $intern_10 = 'null', $intern_38 = 'onModuleLoadStart', $intern_81 = 'org.gwtwidgets.client.util.regex.', $intern_4 = 'price is : ', $intern_19 = 'radix ', $intern_1 = 'response', $intern_36 = 'startup', $intern_14 = 'toString', $intern_29 = '{', $intern_31 = '}';
var _;
...
function com_example_friends_client_Friends_quickParse__(){
  var $e0, $e1, pattern, price, prices, splitString, temp;
  price = 0;
  pattern = org_gwtwidgets_client_util_regex_Pattern_$Pattern__Lorg_gwtwidgets_client_util_regex_Pattern_2Ljava_lang_String_2(new org_gwtwidgets_client_util_regex_Pattern(), $intern_2);
  prices = org_gwtwidgets_client_util_regex_Pattern_$match__Lorg_gwtwidgets_client_util_regex_Pattern_2Ljava_lang_String_2(pattern, this.com_example_friends_client_Friends_linkText);
  if (prices.length == 0)
    return price;
  else {
    temp = prices[0].substr(0, prices[0].length - 2 - 0);
    try {
      ...
      if (com_google_gwt_lang_Cast_instanceOf__Ljava_lang_Object_2I($e0, 2)) {
        splitString = java_lang_String_$split__Ljava_lang_String_2Ljava_lang_String_2I(temp, $intern_3, 0);
...
_.quickParse__ = com_example_friends_client_Friends_quickParse__;
_.java_lang_Object_typeId$ = 0;
_.com_example_friends_client_Friends_linkText = $intern_5;
function com_example_friends_client_FriendsGadgetImpl_$FriendsGadgetImpl__Lcom_example_friends_client_FriendsGadgetImpl_2(this$static){
  ...
  com_example_friends_client_Friends_$bringLink__Lcom_example_friends_client_Friends_2Ljava_lang_String_2(this$static, $intern_6);
  return this$static;
}
...
function com_google_gwt_core_client_JavaScriptException_getProperties__Ljava_lang_Object_2(e){
  return e != null && (e.java_lang_Object_typeMarker$ != nullMethod && e.java_lang_Object_typeId$ != 2)?com_google_gwt_core_client_JavaScriptException_getProperties0__Lcom_google_gwt_core_client_JavaScriptObject_2(com_google_gwt_lang_Cast_dynamicCastJso__Ljava_lang_Object_2(e)):$intern_5;
}
  ...
  try {
    for (prop in e) {
      if (prop != $intern_12 && (prop != $intern_13 && prop != $intern_14)) {
        try {
          result += $intern_15 + prop + $intern_7 + e[prop];
        }
         catch (ignored) {
        }
      }
...
function com_google_gwt_core_client_JavaScriptObject_$toString__Lcom_google_gwt_core_client_JavaScriptObject_2(this$static){
  return this$static.toString?this$static.toString():$intern_16;
}
...
function com_google_gwt_core_client_JavaScriptObject_toString_1_1devirtual$__Ljava_lang_Object_2(this$static){
  return this$static.java_lang_Object_typeMarker$ == nullMethod || this$static.java_lang_Object_typeId$ == 2?this$static.toString__$():this$static.toString?this$static.toString():$intern_16;
}
...
function java_lang_Class_toString__(){
  return ((this.java_lang_Class_modifiers & 2) != 0?$intern_17:(this.java_lang_Class_modifiers & 1) != 0?$intern_5:$intern_18) + this.java_lang_Class_typeName;
}
...
function java_lang_Number__1_1parseAndValidateInt__Ljava_lang_String_2III(s, radix, lowerBound, upperBound){
  ...
  if (s == null) {
    throw java_lang_NumberFormatException_$NumberFormatException__Ljava_lang_NumberFormatException_2Ljava_lang_String_2(new java_lang_NumberFormatException(), $intern_10);
  }
  if (radix < 2 || radix > 36) {
    throw java_lang_NumberFormatException_$NumberFormatException__Ljava_lang_NumberFormatException_2Ljava_lang_String_2(new java_lang_NumberFormatException(), $intern_19 + radix + $intern_20);
  }
  length = s.length;
  startIndex = length > 0 && s.charCodeAt(0) == 45?1:0;
  for (i = startIndex; i < length; ++i) {
    if (java_lang_Character_digit__CI(s.charCodeAt(i), radix) == -1) {
      throw java_lang_NumberFormatException_$NumberFormatException__Ljava_lang_NumberFormatException_2Ljava_lang_String_2(new java_lang_NumberFormatException(), $intern_21 + s + $intern_22);
    }
  }
...
function java_lang_String_$split__Ljava_lang_String_2Ljava_lang_String_2I(this$static, regex, maxMatch){
  var compiled = new RegExp(regex, $intern_23);
  var out = [];
  var count = 0;
...
function java_util_AbstractCollection_add__Ljava_lang_Object_2(o){
  throw java_lang_UnsupportedOperationException_$UnsupportedOperationException__Ljava_lang_UnsupportedOperationException_2Ljava_lang_String_2(new java_lang_UnsupportedOperationException(), $intern_25);
}
...
function java_util_AbstractCollection_toString__(){
  ...
  comma = null;
  com_google_gwt_core_client_impl_StringBufferImplArrayBase_$append__Lcom_google_gwt_core_client_impl_StringBufferImplArrayBase_2Ljava_lang_Object_2Ljava_lang_String_2(sb.java_lang_StringBuffer_data, $intern_26);
  ...
  while (iter.hasNext__()) {
    ...
    java_lang_StringBuffer_$append__Ljava_lang_StringBuffer_2Ljava_lang_String_2(sb, $intern_5 + iter.next__());
  }
...
function java_util_AbstractMap_toString__(){
  ...
  for (iter = java_util_AbstractHashMap$EntrySetIterator_$AbstractHashMap$EntrySetIterator__Ljava_util_AbstractHashMap$EntrySetIterator_2(new java_util_AbstractHashMap$EntrySetIterator(), java_util_AbstractHashMap$EntrySet_$AbstractHashMap$EntrySet__Ljava_util_AbstractHashMap$EntrySet_2(new java_util_AbstractHashMap$EntrySet(), com_google_gwt_lang_Cast_dynamicCast__Ljava_lang_Object_2I(this, 6)).java_util_AbstractHashMap$EntrySet_this$0); java_util_AbstractList$IteratorImpl_$hasNext__Ljava_util_AbstractList$IteratorImpl_2(iter.java_util_AbstractHashMap$EntrySetIterator_iter);) {
    ...
    s += $intern_5 + entry.getKey__();
    s += $intern_30;
    s += $intern_5 + entry.getValue__();
  }
  return s + $intern_31;
}
...
function java_util_AbstractMapEntry_toString__(){
  return this.getKey__() + $intern_30 + this.getValue__();
}
...
function java_util_AbstractHashMap$MapEntryString_getValue__(){
  return this.java_util_AbstractHashMap$MapEntryString_this$0.java_util_AbstractHashMap_stringMap[$intern_24 + this.java_util_AbstractHashMap$MapEntryString_key];
}
...
function java_util_AbstractList_indexOutOfBounds__II(index, size){
  throw java_lang_IndexOutOfBoundsException_$IndexOutOfBoundsException__Ljava_lang_IndexOutOfBoundsException_2Ljava_lang_String_2(new java_lang_IndexOutOfBoundsException(), $intern_32 + index + $intern_33 + size);
}
...
function org_gwtwidgets_client_util_regex_Pattern_$Pattern__Lorg_gwtwidgets_client_util_regex_Pattern_2Ljava_lang_String_2(this$static, pattern){
  this$static.org_gwtwidgets_client_util_regex_Pattern_regExp = org_gwtwidgets_client_util_regex_Pattern_createExpression__Ljava_lang_String_2I(pattern, 0);
  return this$static;
}

function org_gwtwidgets_client_util_regex_Pattern_$_1match__Lorg_gwtwidgets_client_util_regex_Pattern_2Ljava_lang_String_2Ljava_util_List_2(this$static, text, matches){
  var regExp = this$static.org_gwtwidgets_client_util_regex_Pattern_regExp;
...
function org_gwtwidgets_client_util_regex_Pattern_$match__Lorg_gwtwidgets_client_util_regex_Pattern_2Ljava_lang_String_2(this$static, text){
  var arr, i, matches;
  matches = java_util_ArrayList_$ArrayList__Ljava_util_ArrayList_2(new java_util_ArrayList());
  org_gwtwidgets_client_util_regex_Pattern_$_1match__Lorg_gwtwidgets_client_util_regex_Pattern_2Ljava_lang_String_2Ljava_util_List_2(this$static, text, matches);
...
function org_gwtwidgets_client_util_regex_Pattern_createExpression__Ljava_lang_String_2I(pattern, flags){
  var sFlags;
  sFlags = $intern_5;
  if ((flags & 1) != 0)
    sFlags += $intern_34;
  if ((flags & 2) != 0)
    sFlags += $intern_35;
  return new RegExp(pattern, sFlags);
}

function org_gwtwidgets_client_util_regex_Pattern_getClass__(){
  return com_google_gwt_lang_ClassLiteralHolder_Lorg_1gwtwidgets_1client_1util_1regex_1Pattern_12_1classLit;
}

function org_gwtwidgets_client_util_regex_Pattern_toString__(){
  return com_google_gwt_core_client_JavaScriptObject_$toString__Lcom_google_gwt_core_client_JavaScriptObject_2(this.org_gwtwidgets_client_util_regex_Pattern_regExp);
}

function org_gwtwidgets_client_util_regex_Pattern(){
}

_ = org_gwtwidgets_client_util_regex_Pattern.prototype = new java_lang_Object();
_.getClass__$ = org_gwtwidgets_client_util_regex_Pattern_getClass__;
_.toString__$ = org_gwtwidgets_client_util_regex_Pattern_toString__;
_.java_lang_Object_typeId$ = 0;
_.org_gwtwidgets_client_util_regex_Pattern_regExp = null;
function init(){
  !!$stats && $stats({moduleName:$moduleName, subSystem:$intern_36, evtGroup:$intern_37, millis:(new Date()).getTime(), type:$intern_38, className:$intern_39});
...
var com_google_gwt_lang_ClassLiteralHolder__13Ljava_1lang_1String_12_1classLit = java_lang_Class_createForArray__Ljava_lang_String_2Ljava_lang_String_2($intern_40, $intern_41), com_google_gwt_lang_ClassLiteralHolder_Ljava_1lang_1Object_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_42, $intern_43), com_google_gwt_lang_ClassLiteralHolder_Lcom_1google_1gwt_1gadgets_1client_1Gadget_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_44, $intern_45), com_google_gwt_lang_ClassLiteralHolder_Lcom_1example_1friends_1client_1Friends_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_46, $intern_47), com_google_gwt_lang_ClassLiteralHolder_Lcom_1example_1friends_1client_1FriendsGadgetImpl_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_46, $intern_48), com_google_gwt_lang_ClassLiteralHolder_Lcom_1example_1friends_1client_1OpenSocialFeature_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_46, $intern_49), com_google_gwt_lang_ClassLiteralHolder_Ljava_1lang_1Throwable_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_42, $intern_50), com_google_gwt_lang_ClassLiteralHolder_Ljava_1lang_1Exception_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_42, $intern_51), com_google_gwt_lang_ClassLiteralHolder_Ljava_1lang_1RuntimeException_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_42, $intern_52), com_google_gwt_lang_ClassLiteralHolder_Lcom_1google_1gwt_1core_1client_1JavaScriptException_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_53, $intern_54), com_google_gwt_lang_ClassLiteralHolder_Lcom_1google_1gwt_1core_1client_1JavaScriptObject_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_53, $intern_55), com_google_gwt_lang_ClassLiteralHolder_Ljava_1lang_1IndexOutOfBoundsException_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_42, $intern_56), com_google_gwt_lang_ClassLiteralHolder_Ljava_1lang_1ArrayStoreException_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_42, $intern_57), com_google_gwt_lang_ClassLiteralHolder__13C_1classLit = java_lang_Class_createForArray__Ljava_lang_String_2Ljava_lang_String_2($intern_5, $intern_58), com_google_gwt_lang_ClassLiteralHolder_Ljava_1lang_1Class_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_42, $intern_59), com_google_gwt_lang_ClassLiteralHolder_Ljava_1lang_1ClassCastException_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_42, $intern_60), com_google_gwt_lang_ClassLiteralHolder_Ljava_1lang_1IllegalArgumentException_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_42, $intern_61), com_google_gwt_lang_ClassLiteralHolder_Ljava_1lang_1NumberFormatException_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_42, $intern_62), com_google_gwt_lang_ClassLiteralHolder_Ljava_1lang_1String_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_42, $intern_11), com_google_gwt_lang_ClassLiteralHolder_Ljava_1lang_1StringBuffer_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_42, $intern_63), com_google_gwt_lang_ClassLiteralHolder_Ljava_1lang_1UnsupportedOperationException_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_42, $intern_64), com_google_gwt_lang_ClassLiteralHolder__13Ljava_1lang_1Object_12_1classLit = java_lang_Class_createForArray__Ljava_lang_String_2Ljava_lang_String_2($intern_40, $intern_65), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1AbstractCollection_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_66, $intern_67), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1AbstractMap_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_66, $intern_68), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1AbstractHashMap_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_66, $intern_69), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1AbstractSet_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_66, $intern_70), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1AbstractHashMap$EntrySet_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_66, $intern_71), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1AbstractHashMap$EntrySetIterator_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_66, $intern_72), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1AbstractMapEntry_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_66, $intern_73), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1AbstractHashMap$MapEntryNull_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_66, $intern_74), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1AbstractHashMap$MapEntryString_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_66, $intern_75), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1AbstractList_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_66, $intern_76), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1AbstractList$IteratorImpl_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_66, $intern_77), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1ArrayList_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_66, $intern_78), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1HashMap_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_66, $intern_79), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1NoSuchElementException_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_66, $intern_80), com_google_gwt_lang_ClassLiteralHolder_Lorg_1gwtwidgets_1client_1util_1regex_1Pattern_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_81, $intern_82);
