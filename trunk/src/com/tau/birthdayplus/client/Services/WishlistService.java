...
public interface WishlistService extends RemoteService{
	 ...
	 * setActive = false
	 */
	void bookItemForGroup(String itemId, String userId,String message) throws UserNotFoundException, UserException, Exception;
	/*
	 ...
	 * buyer = null
	 */
	void cancelBookItemForGroup(String itemId, String userId) throws UserNotFoundException, UserException;
	/*
