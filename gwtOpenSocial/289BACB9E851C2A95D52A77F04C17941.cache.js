...
function com_example_friends_client_Friends_onLoadInfo__Lcom_google_gwt_core_client_JavaScriptObject_2(data){
  ...
  if (!user.hadError()) {
    ...
    that.com_example_friends_client_Friends_user.setName__Ljava_lang_String_2(viewer.getDisplayName());
...
function com_example_friends_client_Friends_print__(){
  $wnd.alert(this.com_example_friends_client_Friends_user.com_example_friends_client_Person_name);
}
