...
var $intern_11 = '', $intern_22 = ', ', $intern_28 = ', Size: ', $intern_6 = '403', $intern_19 = ':', $intern_16 = ': ', $intern_25 = '=', $intern_0 = '@', $intern_61 = 'AbstractCollection', $intern_63 = 'AbstractHashMap', $intern_65 = 'AbstractHashMap$EntrySet', $intern_66 = 'AbstractHashMap$EntrySetIterator', $intern_68 = 'AbstractHashMap$MapEntryNull', $intern_69 = 'AbstractHashMap$MapEntryString', $intern_70 = 'AbstractList', $intern_71 = 'AbstractList$IteratorImpl', $intern_62 = 'AbstractMap', $intern_67 = 'AbstractMapEntry', $intern_64 = 'AbstractSet', $intern_20 = 'Add not supported on this collection', $intern_8 = 'An unexpected error occurred.', $intern_72 = 'ArrayList', $intern_52 = 'ArrayStoreException', $intern_54 = 'Class', $intern_55 = 'ClassCastException', $intern_47 = 'Exception', $intern_13 = 'FRIENDS', $intern_40 = 'Friends', $intern_41 = 'FriendsGadgetImpl', $intern_38 = 'Gadget', $intern_73 = 'HashMap', $intern_27 = 'Index: ', $intern_51 = 'IndexOutOfBoundsException', $intern_50 = 'JavaScriptObject$', $intern_74 = 'MapEntryImpl', $intern_75 = 'NoSuchElementException', $intern_36 = 'Object', $intern_59 = 'Object;', $intern_42 = 'OpenSocialFeature', $intern_7 = 'Please adjust the gadgets settings to use social features', $intern_48 = 'RuntimeException', $intern_56 = 'String', $intern_34 = 'String;', $intern_57 = 'StringBuffer', $intern_44 = 'StringBufferImpl', $intern_45 = 'StringBufferImplAppend', $intern_46 = 'Throwable', $intern_58 = 'UnsupportedOperationException', $intern_12 = 'VIEWER', $intern_21 = '[', $intern_1 = '[1-9],{0,1}(\\d)* \u20AA', $intern_53 = '[C', $intern_15 = '[JavaScriptObject]', $intern_33 = '[Ljava.lang.', $intern_23 = ']', $intern_18 = 'class ', $intern_39 = 'com.example.friends.client.', $intern_32 = 'com.example.friends.client.Friends', $intern_49 = 'com.google.gwt.core.client.', $intern_43 = 'com.google.gwt.core.client.impl.', $intern_37 = 'com.google.gwt.gadgets.client.', $intern_14 = 'continue', $intern_9 = 'first', $intern_5 = 'forbidden', $intern_2 = 'g', $intern_10 = 'http://model.aspx?modelid=728162', $intern_17 = 'interface ', $intern_35 = 'java.lang.', $intern_60 = 'java.util.', $intern_30 = 'moduleStartup', $intern_31 = 'onModuleLoadStart', $intern_29 = 'startup', $intern_3 = 'viewer', $intern_4 = 'viewerFriends', $intern_24 = '{', $intern_26 = '}';
var _;
...
function com_example_friends_client_Friends__1match__Ljava_lang_String_2Ljava_util_List_2(text, matches){
  var regExp = new RegExp($intern_1, $intern_2);
...
function com_example_friends_client_Friends_onLoadInfo__Lcom_google_gwt_core_client_JavaScriptObject_2(data){
  var user = data.get($intern_3);
  if (!user.hadError()) {
    var viewer = data.get($intern_3).getData();
    var viewerFriends = data.get($intern_4).getData();
...
function com_example_friends_client_Friends_parse__(){
  ...
  $wnd.alert($intern_9 + output[0]);
}

function com_example_friends_client_Friends_print__(){
  com_example_friends_client_Friends_$bringLink__Lcom_example_friends_client_Friends_2Ljava_lang_String_2(this, $intern_10);
}
...
_.java_lang_Object_typeId$ = 0;
_.com_example_friends_client_Friends_linkText = null;
_.com_example_friends_client_Friends_userId = $intern_11;
function com_example_friends_client_FriendsGadgetImpl_$FriendsGadgetImpl__Lcom_example_friends_client_FriendsGadgetImpl_2(this$static){
  ...
  com_example_friends_client_Friends_$getSocialInfo__Lcom_example_friends_client_Friends_2_req_0.add(com_example_friends_client_Friends_$getSocialInfo__Lcom_example_friends_client_Friends_2_req_0.newFetchPersonRequest($intern_12), $intern_3);
  com_example_friends_client_Friends_$getSocialInfo__Lcom_example_friends_client_Friends_2_viewerFriends_0 = $wnd.opensocial.newIdSpec({userId:$intern_12, groupId:$intern_13});
  com_example_friends_client_Friends_$getSocialInfo__Lcom_example_friends_client_Friends_2_opt_params_0 = {};
...
_.java_lang_Object_typeId$ = 0;
_.com_google_gwt_core_client_impl_StringBufferImplAppend_string = $intern_11;
...
var com_google_gwt_lang_Cast_typeIdArray = [{}, {}, {1:1, 7:1, 8:1, 9:1}, {2:1, 7:1}, {2:1, 7:1}, {2:1, 7:1}, {2:1, 7:1}, {2:1, 7:1}, {2:1, 7:1}, {2:1, 7:1}, {2:1, 7:1}, {2:1, 7:1}, {2:1, 7:1}, {8:1}, {2:1, 7:1}, {6:1}, {3:1}, {3:1}, {3:1}, {4:1, 7:1}, {5:1, 7:1}, {3:1}, {2:1, 7:1}, {10:1}];
...
function java_lang_Throwable_toString__(){
  ...
  if (msg != null) {
    return className + $intern_16 + msg;
  }
   else {
    return className;
  }
...
function java_lang_Class_toString__(){
  return ((this.java_lang_Class_modifiers & 2) != 0?$intern_17:(this.java_lang_Class_modifiers & 1) != 0?$intern_11:$intern_18) + this.java_lang_Class_typeName;
}
...
function java_util_AbstractCollection_add__Ljava_lang_Object_2(o){
  throw java_lang_UnsupportedOperationException_$UnsupportedOperationException__Ljava_lang_UnsupportedOperationException_2Ljava_lang_String_2(new java_lang_UnsupportedOperationException(), $intern_20);
}
...
function java_util_AbstractCollection_toString__(){
  ...
  comma = null;
  sb.java_lang_StringBuffer_impl.com_google_gwt_core_client_impl_StringBufferImplAppend_string += $intern_21;
  ...
  while (iter.hasNext__()) {
    ...
    java_lang_StringBuffer_$append__Ljava_lang_StringBuffer_2Ljava_lang_String_2(sb, $intern_11 + iter.next__());
  }
  sb.java_lang_StringBuffer_impl.com_google_gwt_core_client_impl_StringBufferImplAppend_string += $intern_23;
...
function java_util_AbstractMap_toString__(){
  ...
  for (iter = java_util_AbstractHashMap$EntrySetIterator_$AbstractHashMap$EntrySetIterator__Ljava_util_AbstractHashMap$EntrySetIterator_2(new java_util_AbstractHashMap$EntrySetIterator(), java_util_AbstractHashMap$EntrySet_$AbstractHashMap$EntrySet__Ljava_util_AbstractHashMap$EntrySet_2(new java_util_AbstractHashMap$EntrySet(), com_google_gwt_lang_Cast_dynamicCast__Ljava_lang_Object_2I(this, 5)).java_util_AbstractHashMap$EntrySet_this$0); java_util_AbstractList$IteratorImpl_$hasNext__Ljava_util_AbstractList$IteratorImpl_2(iter.java_util_AbstractHashMap$EntrySetIterator_iter);) {
    ...
    s += $intern_11 + entry.getKey__();
    s += $intern_25;
    s += $intern_11 + entry.getValue__();
  }
  return s + $intern_26;
}
...
function java_util_AbstractHashMap_$hasStringValue__Ljava_util_AbstractHashMap_2Ljava_lang_String_2(this$static, key){
  return $intern_19 + key in this$static.java_util_AbstractHashMap_stringMap;
}
...
function java_util_AbstractMapEntry_toString__(){
  return this.getKey__() + $intern_25 + this.getValue__();
}
...
function java_util_AbstractHashMap$MapEntryString_getValue__(){
  return this.java_util_AbstractHashMap$MapEntryString_this$0.java_util_AbstractHashMap_stringMap[$intern_19 + this.java_util_AbstractHashMap$MapEntryString_key];
}
...
function java_util_AbstractList_indexOutOfBounds__II(index, size){
  throw java_lang_IndexOutOfBoundsException_$IndexOutOfBoundsException__Ljava_lang_IndexOutOfBoundsException_2Ljava_lang_String_2(new java_lang_IndexOutOfBoundsException(), $intern_27 + index + $intern_28 + size);
}
...
function init(){
  !!$stats && $stats({moduleName:$moduleName, subSystem:$intern_29, evtGroup:$intern_30, millis:(new Date()).getTime(), type:$intern_31, className:$intern_32});
...
var com_google_gwt_lang_ClassLiteralHolder__13Ljava_1lang_1String_12_1classLit = java_lang_Class_createForArray__Ljava_lang_String_2Ljava_lang_String_2($intern_33, $intern_34), com_google_gwt_lang_ClassLiteralHolder_Ljava_1lang_1Object_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_35, $intern_36), com_google_gwt_lang_ClassLiteralHolder_Lcom_1google_1gwt_1gadgets_1client_1Gadget_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_37, $intern_38), com_google_gwt_lang_ClassLiteralHolder_Lcom_1example_1friends_1client_1Friends_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_39, $intern_40), com_google_gwt_lang_ClassLiteralHolder_Lcom_1example_1friends_1client_1FriendsGadgetImpl_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_39, $intern_41), com_google_gwt_lang_ClassLiteralHolder_Lcom_1example_1friends_1client_1OpenSocialFeature_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_39, $intern_42), com_google_gwt_lang_ClassLiteralHolder_Lcom_1google_1gwt_1core_1client_1impl_1StringBufferImpl_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_43, $intern_44), com_google_gwt_lang_ClassLiteralHolder_Lcom_1google_1gwt_1core_1client_1impl_1StringBufferImplAppend_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_43, $intern_45), com_google_gwt_lang_ClassLiteralHolder_Ljava_1lang_1Throwable_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_35, $intern_46), com_google_gwt_lang_ClassLiteralHolder_Ljava_1lang_1Exception_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_35, $intern_47), com_google_gwt_lang_ClassLiteralHolder_Ljava_1lang_1RuntimeException_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_35, $intern_48), com_google_gwt_lang_ClassLiteralHolder_Lcom_1google_1gwt_1core_1client_1JavaScriptObject_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_49, $intern_50), com_google_gwt_lang_ClassLiteralHolder_Ljava_1lang_1IndexOutOfBoundsException_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_35, $intern_51), com_google_gwt_lang_ClassLiteralHolder_Ljava_1lang_1ArrayStoreException_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_35, $intern_52), com_google_gwt_lang_ClassLiteralHolder__13C_1classLit = java_lang_Class_createForArray__Ljava_lang_String_2Ljava_lang_String_2($intern_11, $intern_53), com_google_gwt_lang_ClassLiteralHolder_Ljava_1lang_1Class_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_35, $intern_54), com_google_gwt_lang_ClassLiteralHolder_Ljava_1lang_1ClassCastException_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_35, $intern_55), com_google_gwt_lang_ClassLiteralHolder_Ljava_1lang_1String_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_35, $intern_56), com_google_gwt_lang_ClassLiteralHolder_Ljava_1lang_1StringBuffer_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_35, $intern_57), com_google_gwt_lang_ClassLiteralHolder_Ljava_1lang_1UnsupportedOperationException_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_35, $intern_58), com_google_gwt_lang_ClassLiteralHolder__13Ljava_1lang_1Object_12_1classLit = java_lang_Class_createForArray__Ljava_lang_String_2Ljava_lang_String_2($intern_33, $intern_59), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1AbstractCollection_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_60, $intern_61), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1AbstractMap_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_60, $intern_62), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1AbstractHashMap_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_60, $intern_63), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1AbstractSet_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_60, $intern_64), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1AbstractHashMap$EntrySet_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_60, $intern_65), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1AbstractHashMap$EntrySetIterator_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_60, $intern_66), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1AbstractMapEntry_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_60, $intern_67), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1AbstractHashMap$MapEntryNull_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_60, $intern_68), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1AbstractHashMap$MapEntryString_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_60, $intern_69), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1AbstractList_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_60, $intern_70), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1AbstractList$IteratorImpl_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_60, $intern_71), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1ArrayList_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_60, $intern_72), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1HashMap_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_60, $intern_73), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1MapEntryImpl_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_60, $intern_74), com_google_gwt_lang_ClassLiteralHolder_Ljava_1util_1NoSuchElementException_12_1classLit = java_lang_Class_createForClass__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_Class_2($intern_60, $intern_75);
