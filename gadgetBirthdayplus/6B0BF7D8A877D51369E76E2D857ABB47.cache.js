...
function ts(){}
var lh=bn(tb,ub),mh=bn(vb,wb);$stats && $stats({moduleName:'sadna',subSystem:'startup',evtGroup:'moduleStartup',millis:(new Date()).getTime(),type:'moduleEvalEnd'});if (sadna) sadna.onScriptLoad(gwtOnLoad);})();